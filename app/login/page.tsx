...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (storedEmail) {
      ...
      setAccepted(true); // Auto-accept if returning user
    }
  ...
  // Show EmailGate for passwordless flow
  if (showEmailGate) {
    return <EmailGate onProceed={handleEmailGateProceed} onCancel={handleEmailGateCancel} />;
  }

  // PASSWORDLESS METHOD - Show magic link form by default
          ...
          <div className="bg-white shadow-xl shadow-slate-200/50 border border-slate-100 rounded-2xl p-6">
            <div className="text-center mb-6">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Magic link access - no password needed! Education only. 30‑day free trial.
              </p>
            </div>
            ...
            <form onSubmit={handleMagicLink} className="grid gap-4">
              ...
              {process.env.NEXT_PUBLIC_AUTH_METHOD === 'both' && (
                <button
                  type="button"
  ...
  // OAUTH METHOD - Show OAuth buttons
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
        ...
        <div className="bg-white shadow-xl shadow-slate-200/50 border border-slate-100 rounded-2xl p-6">
          <div className="text-center mb-6">
            ...
            <h1 className="mt-3 text-2xl font-semibold tracking-tight text-slate-900">Sign in to ZeroFinanx</h1>
            <p className="mt-1 text-sm text-slate-600">
              Sign in to access your account. Education only. 30‑day free trial.
            </p>
          </div>
          ...
          <div className="grid gap-3">
            ...
            {process.env.NEXT_PUBLIC_AUTH_METHOD === 'both' && (
              <button
                ...
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium hover:bg-slate-50"
              >
